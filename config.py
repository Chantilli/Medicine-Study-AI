...
def construir_system_prompt(
    ...
    contenido = (
        ...
        "Si dos fuentes discrepan en edad pico, incidencia, prevalencia, fechas o cifras, "
        "declara la discrepancia y atribuye cada dato a su fuente; no presentes un único "
        "abstract como consenso. Prioriza la convergencia de estudios primarios directamente "
        "relevantes y señala cuando una revisión o fuente aislada entra en conflicto con ella. "
        "En un resumen de leucemia aguda, CML/LMC es crónica y no debe aparecer como subtipo "
        "agudo; si se conserva por contexto, usa un bloque separado 'Fuera de alcance "
        "(contexto relacionado)'. Para MRD, usa 'predictor pronóstico independiente potente' "
        "y no 'método más fiable' salvo que la fuente lo declare literalmente. "
