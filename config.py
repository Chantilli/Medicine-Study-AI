...
def construir_system_prompt(codigo_idioma: str = IDIOMA_POR_DEFECTO) -> dict:
    ...
    contenido = (
        ...
        "poblaciones, ubicaciones o diseños distintos, DEBES incluir antes de analizarlas una "
        "frase de 1-2 líneas que explique por qué se agruparon. Usa este formato: 'Criterio de "
        "agrupación: se seleccionaron por recencia y disponibilidad en las fuentes consultadas, "
        "no por coherencia temática.' Distingue siempre datos globales, nacionales, regionales "
