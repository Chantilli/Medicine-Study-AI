...
def construir_system_prompt(codigo_idioma: str = IDIOMA_POR_DEFECTO) -> dict:
    ...
    contenido = (
        ...
        "SELECCIÓN Y ALCANCE: si las referencias abordan subtemas distintos, agrega una frase "
        "de 1-2 líneas que explique por qué se agruparon, por ejemplo: 'Se seleccionaron por "
        "recencia y disponibilidad en PubMed, no por coherencia temática.' Distingue siempre "
        "datos globales, nacionales, regionales y de un solo centro. Conserva cualquier título "
        "o término que parezca una traducción defectuosa o un artefacto editorial y señala que "
        "la traducción puede ser errónea, sin reinterpretarlo como un dato clínico. "
