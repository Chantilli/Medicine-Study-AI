...
TEXTOS = {
    ...
    "pdf_procesando": {
        "es": "⏳ Procesando y extrayendo texto del PDF...", "en": "⏳ Processing and extracting text from the PDF...",
        "fr": "⏳ Traitement et extraction du texte du PDF...", "de": "⏳ PDF wird verarbeitet und Text extrahiert...",
        "zh": "⏳ 正在处理并提取 PDF 文本…",
    },
    "pdf_no_identificado": {
        "es": "❌ Archivo no identificado", "en": "❌ File not recognized", "fr": "❌ Fichier non identifié",
    ...
    "pdf_indexado": {
        "es": "✅ PDF indexado ({n} fragmentos): {nombre}...", "en": "✅ PDF indexed ({n} fragments): {nombre}...",
        "fr": "✅ PDF indexé ({n} fragments) : {nombre}...", "de": "✅ PDF indiziert ({n} Abschnitte): {nombre}...",
        "zh": "✅ PDF 已索引（{n} 个片段）：{nombre}…",
    },
    "pdf_cargado": {
        "es": "✅ PDF cargado (sin búsqueda semántica): {nombre}...", "en": "✅ PDF uploaded (no semantic search): {nombre}...",
        "fr": "✅ PDF chargé (sans recherche sémantique) : {nombre}...", "de": "✅ PDF hochgeladen (ohne semantische Suche): {nombre}...",
        "zh": "✅ PDF 已上传（无语义搜索）：{nombre}…",
    },
    "pdf_sin_ocr": {
        "es": "❌ No se pudo extraer texto (parece escaneado; el OCR no está disponible en este servidor)",
    ...
    "pdf_sin_texto": {
        "es": "❌ No se pudo extraer texto del PDF, ni siquiera con OCR", "en": "❌ Could not extract text from the PDF, not even with OCR",
        "fr": "❌ Impossible d'extraire le texte du PDF, même avec l'OCR", "de": "❌ Aus dem PDF konnte kein Text extrahiert werden, auch nicht mit OCR",
        "zh": "❌ 即使使用 OCR 也无法从 PDF 中提取文本",
    },
    "pdf_error_proceso": {
        "es": "❌ Error al leer el PDF", "en": "❌ Error reading the PDF", "fr": "❌ Erreur lors de la lecture du PDF",
        "de": "❌ Fehler beim Lesen des PDFs", "zh": "❌ 读取 PDF 时出错",
    },
    "pdf_no_procesado": {
        "es": "❌ No se pudo procesar el PDF: {error}", "en": "❌ Could not process the PDF: {error}",
        "fr": "❌ Impossible de traiter le PDF : {error}", "de": "❌ PDF konnte nicht verarbeitet werden: {error}",
        "zh": "❌ 无法处理 PDF：{error}",
    },
    "pdf_cargado_documento": {
        "es": "📎 Has cargado el documento: {nombre}", "en": "📎 You uploaded the document: {nombre}",
        "fr": "📎 Vous avez chargé le document : {nombre}", "de": "📎 Dokument geladen: {nombre}",
        "zh": "📎 已加载文档：{nombre}",
    },
    "tablas_indexadas": {
        "es": " · {n} tabla(s) indexada(s)", "en": " · {n} table(s) indexed", "fr": " · {n} tableau(x) indexé(s)",
        "de": " · {n} Tabelle(n) indiziert", "zh": " · 已索引 {n} 个表格",
    },
    "eliminar_chat": {"es": "Eliminar chat", "en": "Delete chat", "fr": "Supprimer la conversation", "de": "Chat löschen", "zh": "删除聊天"},
    "editar_reenviar": {"es": "Editar y reenviar", "en": "Edit and resend", "fr": "Modifier et renvoyer", "de": "Bearbeiten und erneut senden", "zh": "编辑并重新发送"},
    "icd11_no_disponible": {
        "es": "ICD-11 no disponible: {error}", "en": "ICD-11 unavailable: {error}",
        "fr": "ICD-11 indisponible : {error}", "de": "ICD-11 nicht verfügbar: {error}",
        "zh": "ICD-11 不可用：{error}",
    },
    "icd11_sin_coincidencias": {
        "es": "ICD-11: no se encontró una coincidencia suficientemente fiable",
        "en": "ICD-11: no sufficiently reliable match was found",
        "fr": "ICD-11 : aucune correspondance suffisamment fiable n'a été trouvée",
        "de": "ICD-11: keine ausreichend zuverlässige Übereinstimmung gefunden",
        "zh": "ICD-11：未找到足够可靠的匹配项",
    },
    "login_titulo": {"es": "Iniciar sesión", "en": "Sign in", "fr": "Se connecter", "de": "Anmelden", "zh": "登录"},
    "login_crear": {"es": "Crear cuenta", "en": "Create account", "fr": "Créer un compte", "de": "Konto erstellen", "zh": "创建账户"},
    "login_usuario": {"es": "Usuario", "en": "Username", "fr": "Nom d'utilisateur", "de": "Benutzername", "zh": "用户名"},
    "login_contrasena": {"es": "Contraseña", "en": "Password", "fr": "Mot de passe", "de": "Passwort", "zh": "密码"},
    "login_completa": {"es": "Completa usuario y contraseña.", "en": "Enter a username and password.", "fr": "Saisissez un nom d'utilisateur et un mot de passe.", "de": "Benutzername und Passwort eingeben.", "zh": "请输入用户名和密码。"},
    "login_usuario_corto": {"es": "El usuario debe tener al menos 3 caracteres.", "en": "The username must contain at least 3 characters.", "fr": "Le nom d'utilisateur doit comporter au moins 3 caractères.", "de": "Der Benutzername muss mindestens 3 Zeichen enthalten.", "zh": "用户名至少需要 3 个字符。"},
    "login_contrasena_corta": {"es": "La contraseña debe tener al menos 4 caracteres.", "en": "The password must contain at least 4 characters.", "fr": "Le mot de passe doit comporter au moins 4 caractères.", "de": "Das Passwort muss mindestens 4 Zeichen enthalten.", "zh": "密码至少需要 4 个字符。"},
    "login_incorrecto": {"es": "Usuario o contraseña incorrectos.", "en": "Incorrect username or password.", "fr": "Nom d'utilisateur ou mot de passe incorrect.", "de": "Benutzername oder Passwort falsch.", "zh": "用户名或密码不正确。"},
    "login_tienes_cuenta": {"es": "¿Ya tienes cuenta? Inicia sesión", "en": "Already have an account? Sign in", "fr": "Vous avez déjà un compte ? Connectez-vous", "de": "Schon ein Konto? Anmelden", "zh": "已有账户？登录"},
    "login_no_tienes_cuenta": {"es": "¿No tienes cuenta? Regístrate", "en": "Don't have an account? Sign up", "fr": "Pas encore de compte ? Inscrivez-vous", "de": "Noch kein Konto? Registrieren", "zh": "没有账户？注册"},
    "fuentes_sin_respuesta": {
        "es": "⚠️ La respuesta incluye referencias, pero no se encontraron fuentes reales para esta pregunta. No las tomes como evidencia.",
        "en": "⚠️ The answer includes references, but no real sources were found for this question. Do not treat them as evidence.",
        "fr": "⚠️ La réponse contient des références, mais aucune source réelle n'a été trouvée pour cette question. Ne les considérez pas comme des preuves.",
        "de": "⚠️ Die Antwort enthält Quellenangaben, aber für diese Frage wurden keine echten Quellen gefunden. Behandle sie nicht als Belege.",
        "zh": "⚠️ 回答包含引用，但未找到与此问题对应的真实来源。请勿将其视为证据。",
    },
    "inconsistencia_fisiologica": {
        "es": "🧬 Posible inconsistencia fisiológica detectada; revisa la respuesta antes de confiar en ella.",
        "en": "🧬 A possible physiological inconsistency was detected; review the answer before relying on it.",
        "fr": "🧬 Une possible incohérence physiologique a été détectée ; vérifiez la réponse avant de vous y fier.",
        "de": "🧬 Eine mögliche physiologische Inkonsistenz wurde erkannt; prüfe die Antwort, bevor du dich darauf verlässt.",
        "zh": "🧬 检测到可能的生理学矛盾；请先检查回答再依赖它。",
    },
    "contexto_pdf": {
        "es": "[FRAGMENTOS RELEVANTES DE TUS DOCUMENTOS, recuperados por búsqueda semántica]:",
        "en": "[RELEVANT FRAGMENTS FROM YOUR DOCUMENTS, retrieved by semantic search]:",
        "fr": "[FRAGMENTS PERTINENTS DE VOS DOCUMENTS, récupérés par recherche sémantique] :",
        "de": "[RELEVANTE FRAGMENTE AUS DEINEN DOKUMENTEN, durch semantische Suche abgerufen]:",
        "zh": "[通过语义搜索检索到的文档相关片段]：",
    },
